...
/**
 * Some commonly used CoAP content formats.
 */
typedef enum {
...
extern const NabtoClientError NABTO_CLIENT_ERROR_PARSE;
extern const NabtoClientError NABTO_CLIENT_ERROR_BAD_RESPONSE;
...
// Coap error codes
extern const NabtoClientError NABTO_CLIENT_COAP_NO_CONTENT_FORMAT;
...
// Tunnel error codes
extern const NabtoClientError NABTO_CLIENT_TUNNEL_PORT_IN_USE;
...
/**
 * The buffer resource contains a buffer of continouos data
 */
 ...
 */
NABTO_CLIENT_DECL_PREFIX NabtoClientError NABTO_CLIENT_API
nabto_client_connection_get_client_fingerprint_hex(NabtoClientConnection* connection, char* fingerprint);
 ...
 */
NABTO_CLIENT_DECL_PREFIX NabtoClientFuture* NABTO_CLIENT_API
nabto_client_stream_open(NabtoClientStream* stream, uint32_t port);
 ...
 * NabtoClientBuffer* payload = nabto_client_coap_get_response_payload(coap);
 *
 * Do stuff here with the response.
 *
 * nabto_client_buffer_free(payload);
 ...
 *
 * The following strings is valid methods "GET", "POST", "PUT",
 * "DELETE". The path has to start with a /. "/" is the root path.
 */
...
/**
 * Free a coap request.
 * Outstanding execute futures will be resolved.
 */
NABTO_CLIENT_DECL_PREFIX void NABTO_CLIENT_API
...
// TODO
//NABTO_CLIENT_DECL_PREFIX NabtoClientError NABTO_CLIENT_API
//nabto_client_coap_set_request_accept(NabtoClientCoap* coap, uint16_t contentFormat);
 ...
 */
NABTO_CLIENT_DECL_PREFIX NabtoClientFuture* NABTO_CLIENT_API
nabto_client_coap_execute(NabtoClientCoap* request);
 ...
 *
 *
 * returns NABTO_DEVICE_OK iff response has a contentFormat
 *         NABTO_DEVICE_COAP_NO_CONTENT_FORMAT if the response does not contain a contentFormat
 *         NABTO_DEVICE_COAP_NO_RESPONSE if there is no response ready.
 */
NABTO_CLIENT_DECL_PREFIX NabtoClientError NABTO_CLIENT_API
...
nabto_client_coap_get_response_payload(NabtoClientCoap* coap);
...
NABTO_CLIENT_DECL_PREFIX void NABTO_CLIENT_API
nabto_client_buffer_free(NabtoClientBuffer* buffer);

/**
 * Return a pointer to the buffer data.
 */
NABTO_CLIENT_DECL_PREFIX void* NABTO_CLIENT_API
nabto_client_buffer_data(NabtoClientBuffer* buffer);

/**
 * Return the length of the data in the buffer.
 */
NABTO_CLIENT_DECL_PREFIX size_t NABTO_CLIENT_API
nabto_client_buffer_size(NabtoClientBuffer* buffer);
